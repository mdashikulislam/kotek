...
{  
	...
	if(confirm("Do you want to delete Records??"))
	{
		...
		else
		{
			...
			$.ajax({
				  type: "POST",
				  url: "<?=base_url()?>admin/testimonial/deleteMultiple",
				  data: { id: str },
...
<p>Create, edit, delete and manage Testimonials on your online store. </p>
<p>Testimonials reflects under eNewsletter on Home page.</p>
<a href="<?=base_url()?>admin/testimonial/create" title="Create New Testimonial" class="createTestimonial">Create New Testimonial</a>
...
echo "<td>".form_checkbox('cat_id[]',$list['id'],FALSE,'class="case"')."</td>\n";
		...
		//echo anchor('admin/testimonial/edit/'.$list['id'],'edit');

		echo "<a href='".base_url()."admin/testimonial/edit/".$list['id']."' class='icons' title='Edit'><img src='".base_url()."images/icons/edit.png' /></a>";

		//echo " | ";

		$adata = array('onclick'=>"return deletechecked('Are you sure you want to delete testimonial ?');");

		//echo anchor('admin/testimonial/delete/'.$list['id'],'delete',$adata);

		echo "<a href='".base_url()."admin/testimonial/delete/".$list['id']."' class='icons' title='Delete' onClick=\"return deletechecked('Are you sure you want to delete this testimonial ?');\"><img src='".base_url()."images/icons/delete.png' /></a>";
