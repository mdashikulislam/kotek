  ...
  <!-- Main Content Area starts here -->
  	<div id="maincontent">
        ...
        <ul>
          ...
          <li style="background:none;" class="twinkle"><a href="<?php echo base_url();?>welcome/twinkle_gives_back" title="Twinkle Gives Back" <?php $url_key = $this->uri->segment(2); if($url_key =='twinkle_gives_back'){ echo "class='active-tab'";}?>>twinklegivesback</a></li>
        </ul>
        <div id="search">
         <?php 
