...
<div class="topRightWrapper">
    ...
    <div class="emailTop"> <a href="mailto:sales@kotek.com" title="E-mail">E-mail</a> our customer support team.<br/></div>
   ...
   <?php $getHeaderPagesList  = $this->MPages->getHeaderPages();?>
<div class="navigationTop">
  <ul>
    ...
    <!--li><a href="<?php echo base_url()."pages/view/technical-info";?>" title="Technical Info" <?php $url_key = $this->uri->segment(3); if($url_key =='technical-info'){ echo "class='active'";}?>>Technical Info</a></li-->
     ...
     <?php if(!empty($getHeaderPagesList)){ $counterheader = 1; $countF =count($getHeaderPagesList);
			foreach($getHeaderPagesList as $key=>$valueheader){
				?>
            <li><a href="<?php echo base_url();?>pages/view/<?php echo $valueheader['path']; ?>" title="<?php echo $valueheader['name']; ?>" <?php $url_key = $this->uri->segment(3); if($url_key =='contact'){ echo "class='active'";}?>><?php echo $valueheader['name']; ?></a> </li>
            <?php
      ...
      <li><a href="<?php echo base_url();?>pages/view/order_info" title="Buy" <?php $url_key = $this->uri->segment(3); if($url_key =='order_info'){ echo "class='active'";}?>>Buy</a></li>
  </ul>
