...
echo form_open('admin/categories/create',$fdata);

echo "<table cellpadding='3' cellspacing='0' border='0' class='createNewTable'>";

echo "<tr>";
echo "\n<td width='150'><label for='catname'>Name<span class='red'>*</span> :</label></td><td width='810'>\n";
...
$data = array('name'=>'shortdesc','id'=>'short','class'=>'textfield','size'=>40);
echo form_input($data) ."</td>\n";
echo "</tr>";
...
echo "<tr><td>&nbsp;</td><td>";
echo "<input type='submit' value='' class='createGroupBtn' title='Create Group' />";
echo "</td></tr>";
