...
foreach ($products as $key => $list){
	...
	//	echo "<td align='center'></td>\n";
		...
		echo "<a href='".base_url()."index.php/admin/orders/editCustomer/".$list['customer_id']."' class='icons' title='Edit'><img src='".base_url()."images/icons/edit.png' /></a>";
		//echo " | ";
		...
		echo "<a href='".base_url()."index.php/admin/orders/deleteCustomer/".$list['customer_id']."' class='icons' title='Delete' onClick=\"return deletechecked('Are you sure you want to delete this lead ?');\"><img src='".base_url()."images/icons/delete.png' /></a>";
		echo "</td>\n";
		echo "</tr>\n";
	}
	echo "</tbody></table>";
