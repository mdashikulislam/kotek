...
<div class="topRightWrapper">
    ...
    <div class="loginTop"> 
        ...
        <div align="right">
          <?php echo anchor("admin/admins/profile/","My Profile");?>&nbsp;<span style="color:#FFF;">|</span>&nbsp; <?php echo anchor("admin/dashboard/logout/","Logout");?> </div>
      </div>
  </div>
...
<div class="navigationTop">
  <ul id="nav">
    <li><?php echo anchor("admin/dashboard/index","Quick Links");?></li>
    <li><?php echo anchor("admin/pages/", "CMS");?>
    	<ul>
            ...
            <li><?php echo anchor("admin/technical/", "Technical");?>
                <ul>
                    <li> <?php echo anchor("admin/technical/", "Manage Technical");?> </li>
                    <li> <?php echo anchor("admin/technical/create/", "Create New Technical");?> </li>
                </ul>
            </li>
        </ul>
    </li>
    ...
    <li><?php echo anchor("admin/products/", "Product Management");?>
    	<ul>
           ...
           <li><?php echo anchor("admin/dimensions/", "Attributes");?>
            	<ul>
                	<li> <?php echo anchor("admin/dimensions/", "Manage Attributes");?> </li>
                    <li> <?php echo anchor("admin/dimensions/create/", "Create New Attribute");?> </li>
                </ul>
            </li>
        </ul>
    </li>
    
    <li><?php echo anchor("admin/orders/customers", "Customer");?>
    	<ul>
        	<li><?php echo anchor("admin/orders/customers", "Manage Customer");?></li>
       ...
       <li> <?php echo anchor("admin/orders/newRegistration", "New Customer request");?> </li>
       <li> <?php echo anchor("admin/subscribers/requests", "Product request");?> </li>
        </ul>
    </li>
