  ...
  <div id="maincontainer">
    ...
    <div id="maincontent">
      ...
      <div id="container">
		...
		<script type="text/javascript">
        function load(){
            $("#for-tag-image").html('<p><a href="<?php echo base_url();?>index.php/welcome/twinkle_gives_back" title="Twinkle gives back"><img src="./images/twinkle-gives-back-icon.png" alt="Twinkle gives back tag" /></a></p>');
        }
        $(function(){
