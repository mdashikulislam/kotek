...
<a href="<?=base_url()?>index.php/admin/pages/create" title="Create New Page" class="createNewLink">Create New Page</a>
<?php
...
if (count($pages)){
	...
	foreach ($pages as $key => $list){
		...
		echo "<a href='".base_url()."index.php/admin/pages/edit/".$list['id']."' class='icons' title='Edit'><img src='".base_url()."images/icons/edit.png' /></a>";
		//echo " | ";
		//echo anchor('admin/pages/delete/'.$list['id'],'delete');
		echo "<a href='".base_url()."index.php/admin/pages/delete/".$list['id']."' class='icons' title='Delete' onClick=\"return deletechecked('Are you sure you want to delete this pages ?');\"><img src='".base_url()."images/icons/delete.png' /></a>";
		echo "</td>\n";
		echo "</tr>\n";
	}
	echo "</tbody>\n</table></div>";
