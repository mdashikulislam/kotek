...
/* JQUERY EASING jquery.easing.1.2.js */
...
(function($){
	var text_arr = new Array("1","2","3","4","5","6");
    $.anythingSlider = function(el, options){
        ...
        base.init = function(){
            ...
            /* Added by sameer 7th July 1010 */
            base.$items.filter(':last' ).after(base.$items.filter(':second').clone().addClass('cloned'));
		...
		base.buildNavigation = function(){
			...
			base.$items.each(function(i,el){
				...
				$a.click(function(e){
                    ...
                    base.gotoPage(index1);
                    
                    if (base.options.hashTags)
						base.setHash('panel-' + index1);
...
/* INDEX.JS */
	 ...
	 var $k = jQuery.noConflict();
        ...
        $k(function () {
            ...
            $k('.anythingSlider').anythingSlider({
            ...
            $k("#slide-jump").click(function(){
                $k('.anythingSlider').anythingSlider(6);
            });
