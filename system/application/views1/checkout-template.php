...
<div id="wrapper">
  <div id="maincontainer">
    ...
    <div id="maincontent">
      <div id='globalmenu'>
        <ul>
          <li><a href="<?php echo base_url();?>index.php/welcome/photo_gallery" title="Photo Gallery" <?php $url_key = $this->uri->segment(2); if($url_key =='photo_gallery'){ echo "class='active-tab'";} else {echo "class='non-active'";}?>>photo gallery</a></li>
          <li><a href="<?php echo base_url();?>index.php/welcome/shop" title="Shop" <?php $url_key = $this->uri->segment(2); if($url_key =='shop'){ echo "class='active-tab'";}?>>shop</a></li>
          <li><a href="<?php echo base_url();?>index.php/welcome/giftVoucher/20" title="Gift Certificate" <?php $url_key = $this->uri->segment(2); if($url_key =='giftVoucher'){ echo "class='active-tab'";}?>>gifts</a></li>
          <li><a href="<?php echo base_url();?>blog-press" title="Blog &amp; Press" <?php $url_key = $this->uri->segment(2); if($url_key =='blog-press'){ echo "class='active-tab'";}?>>blog &amp; press</a></li>
          <li style="background:none;"><a href="<?php echo base_url();?>index.php/welcome/twinkle_gives_back" title="Twinkle Gives Back" <?php $url_key = $this->uri->segment(2); if($url_key =='twinkle_gives_back'){ echo "class='active-tab'";}?>>twinklegivesback</a></li>
        </ul>
        <div id="search">
         <?php 
      ...
      <div id="footer">
        <p>Copyright &copy; <?php echo date("Y"); ?> twinkle my net - all rights reserved.</p>
