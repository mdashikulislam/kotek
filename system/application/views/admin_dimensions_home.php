...
{  
	...
	if(confirm("Do you want to delete Records??"))
	{
		...
		else
		{
			...
			$.ajax({
				  type: "POST",
				  url: "<?=base_url()?>admin/dimensions/deleteMultiple",
				  data: { id: str },
...
<p>Create, edit, delete and manage Attributes. </p>
<a href="<?=base_url()?>admin/dimensions/create" title="Create New Dimensions" class="createCategory">Create New Attribute</a>
...
echo "<td>".form_checkbox('cat_id[]',$list['id'],FALSE,'class="case"')."</td>\n";
	...
	//	echo "<td align='center'>".$list['status']."</td>\n";
		...
		echo "<a href='".base_url()."admin/dimensions/edit/".$list['id']."' class='icons' title='Edit'><img src='".base_url()."images/icons/edit.png' /></a>";

		//echo " | ";

		//echo anchor('admin/dimensions/delete/'.$list['id'],'delete');

		echo "<a href='".base_url()."admin/dimensions/delete/".$list['id']."' class='icons' title='Delete' onClick=\"return deletechecked('Are you sure you want to delete this dimension ?');\"><img src='".base_url()."images/icons/delete.png' /></a>";
