...
class Orders  extends Controller {
  ...
  function deleteMultiple(){
	...
	$this->MCustomers->deleteUser($row);
	}
	$this->session->set_flashdata('message','Customers deleted sucessfully');
...

  {
   ...
   function newRegistration(){
	...
	$data['title'] = "Manage Customers Registration";
  ...
  function udpateCustomerStatus()
  {
	 $id = $this->uri->segment(4);
	 $status = $this->uri->segment(5);
	 $this->MCustomers->updateCustomerSt($id,$status);   
  }
