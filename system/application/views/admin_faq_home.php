...
{  
	...
	if(confirm("Do you want to delete Records??"))
	{
		...
		else
		{
			...
			$.ajax({
				  type: "POST",
				  url: "<?=base_url()?>admin/faq/deleteMultiple",
				  data: { id: str },
...
<p>Create, edit, delete and manage FAQs on your online store.</p>
...
echo "<td>".form_checkbox('cat_id[]',$list['id'],FALSE,'class="case"')."</td>\n";
		...
		echo "<a href='".base_url()."admin/faq/edit/".$list['id']."' class='icons' title='Edit'><img src='".base_url()."images/icons/edit.png' /></a>";
		...
		echo "<a href='".base_url()."admin/faq/delete/".$list['id']."' class='icons' title='Delete' onClick=\"return deletechecked('Are you sure you want to delete this FAQ ?');\"><img src='".base_url()."images/icons/delete.png' /></a>";
