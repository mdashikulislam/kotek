<?php
class Payments_pro extends Controller 
{
	function __construct()
	{
		...
		$config = array(
			'APIUsername' => "sandbo_1215254764_biz_api1.angelleye.com", 	// PayPal API username of the API caller
			'APIPassword' => "1215254774", 	// PayPal API password of the API caller
			'APISignature' => "AFcWxV21C7fd0v3bYYYRCpSSRl31A8yUF6SKTYho-1n.lV4AafhTVyaQ", 	// PayPal API signature of the API caller
	...
	function Do_direct_payment_demo()
	{
		...
		$PaymentDetails = array(
								...
								'custom' => '', 						// Free-form field for your own use.  256 char max.
								'invnum' => '1232', 						// Your own invoice or tracking number
								'notifyurl' => ''						// URL for receiving Instant Payment Notifications.  This overrides what your profile is set to use.
							);	
