...
echo form_open_multipart('admin/maker/create', $fdata);
...
$data = array('name'=>'name','id'=>'name','class'=>'textfield','size'=>25);
...
$data = array('name'=>'maker_desc','id'=>'maker_desc','rows'=>5, 'cols'=>'40');
echo form_textarea($data) ."</td>\n";
echo "</tr>";

echo "<tr><td>&nbsp;</td><td>";
echo "<input type='submit' value='' class='createMakerBtn' title='Create Maker' />";
echo "</td></tr>";
