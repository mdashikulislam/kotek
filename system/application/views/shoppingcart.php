...
shipAddress();
 ...
 function giftVoucher(){
	...
	$.ajax({
	  url: sitepath+"welcome/giftVoucherPurchase",
	   type: 'POST',
...
function checkremailTotal(){
	...
	$.ajax({
	  url: sitepath+"welcome/checktotalPrice",
	   type: 'POST',		
	  context: document.body,
	  success: function(result){ 
	  if(result == "1")
...
<div id="pleft">
  <div id="cart-structure">
    ...
    <div class="columns-bg">
		...
		<div class="for-buttons"><p><input type="submit" name="update" id="update" title="Update Cart" value="Update" />&nbsp;&nbsp;&nbsp;<a href="<?php echo base_url()."welcome/removeItem/". $PID; ?>" title="Remove Item From Cart">Remove</a></p></div>
    ...
    <div class="continue-button"> <a href="<?php echo base_url();?>welcome/shop" class="c-button" title="Continue Shopping"></a> </div>
    </form>
  </div>
...
-->        <p>Register and save time!</p>
      ...
      <div class="right-col">
        <form name="loginUser" id="loginUser" action="<?php echo base_url();?>welcome/login" method="post">
          <p>Login</p>
          <p>&nbsp;</p>
...
var siteurl =  "http://test:8090/twinklemynet/welcome/addtax";
if(selectState == 'CA'){
   $.ajax({
  url: siteurl,
  context: document.body,
