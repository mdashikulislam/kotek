...
<div class="dashboardWrapper">
    <form method='post' name='bannerForm' id='bannerForm' action='<?php echo base_url() ?>admin/technical/save'>    
        <table cellpadding='3' cellspacing='0' border='0' class='createNewTable'>
            ...
            <tr>
                ...
                <td width='810'><input type='text' name='name' id='name'  class='textfield'></td>
            </tr>
            <tr>
                <td width='150'><label for='name'>Keywords<span class='red'>*</span> :</label></td>
                <td width='810'><input type='text' name='keyword' id='keyword'  class='textfield'></td>
            </tr>
            <tr>
                <td width='150'><label for='name'>Description<span class='red'>*</span> :</label></td>
                <td width='810'><input type='text' name='description' id='description'  class='textfield'></td>
            </tr>
            <tr>
                <td width='150'><label for='name'>Link<span class='red'>*</span> :</label></td>
                <td width='810'>
                    <textarea name="content" id="content" cols="30" rows="4" style="width: 175px; height: 57px;"></textarea>
                </td>
            </tr>
            <tr>
                <td>&nbsp;</td>
                <td><input type='submit' value='CREATE' class='technicalCreateBtn' /></td>
            </tr>
        </table>
    </form>        
</div>
