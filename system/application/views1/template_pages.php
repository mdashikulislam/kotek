  ...
  <div id="maincontainer">
    ...
    <div id="maincontent">
      <div id='globalnav'>
        ...
        <li><?php echo anchor("welcome/shop","shop");?></li>
        <li><?php echo anchor("welcome/contact","contact");?></li>
        <li><?php echo anchor("welcome/pages/about_us","about us");?></li>
        <li><?php echo anchor("welcome/giftVoucher/20","gifts");?></li>
        </ul><?php */?>
        <ul>
          <li class="photo_gallary" id="active_one"><a href="<?php echo base_url();?>index.php/welcome/photo_gallery" title="Photo Gallery" <?php $url_key = $this->uri->segment(2); if($url_key =='photo_gallery'){ echo "class='active-tab'";} else {echo "class='non-active'";}?>>photo gallery</a></li>
          <li class="shop"><a href="<?php echo base_url();?>index.php/welcome/shop" title="Shop" <?php $url_key = $this->uri->segment(2); if($url_key =='shop'){ echo "class='active-tab'";}?>>shop</a></li>
          <li class="gift"><a href="<?php echo base_url();?>index.php/welcome/giftVoucher/20" title="Gift Certificate" <?php $url_key = $this->uri->segment(2); if($url_key =='giftVoucher'){ echo "class='active-tab'";}?>>gifts</a></li>
          ...
          <li style="background:none;" class="twinkle"><a href="<?php echo base_url();?>index.php/welcome/twinkle_gives_back" title="Twinkle Gives Back" <?php $url_key = $this->uri->segment(2); if($url_key =='twinkle_gives_back'){ echo "class='active-tab'";}?>>twinklegivesback</a></li>
        </ul>
        <!--<div id="last-tab">
        <ul>
        	<li><a href="<?php //echo base_url();?>index.php/welcome/twinkle_gives_back" title="Twinkle Gives Back" <?php //$url_key = $this->uri->segment(2); if($url_key =='twinkle_gives_back'){ echo "class='active-tab'";}?>>twinklegivesback</a></li>
        </ul>
        </div>-->
        <div id="search">
          <?php 
                        echo form_open("welcome/search");
                        ?> <input type="text" name="term" id="term"  maxlength ="64" size="15" value="enter keyword or item #"  onfocus="$(this).val('');" /> <?php              
      ...
      <div id="nav">
        <?php $this->load->view('navigation_pages');?>
      </div>
      <div id="mainsection">
