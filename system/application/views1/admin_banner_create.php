...
thumbnail: { required: true, accept: "png|jpe?g|gif", filesize: 50000}         
         
		  },
        messages: { 	title: { required: "Please enter banner title" },
image: "File must be JPG, GIF or PNG, less than 1MB",
thumbnail: "File must be JPG, GIF or PNG, less than 50KB"
		}
	});
      });
...
echo form_open_multipart('admin/banner/create', $fdata);
...
$data = array('name'=>'place_order','id'=>'place_order','class'=>'textfield','size'=>25, 'value'=>'');
echo form_input($data) ."</td>";
echo "</tr>";
...
echo "<tr><td>&nbsp;</td><td>";
echo "<input type='submit' value='' class='createBannerBtn' title='Create Banner' />";
echo "</td></tr>";
