...
<div class="for-photo-gallery">
  ...
  <div class="copyright">
    <div class="foot-links">
      <ul>
        <li><a href="<?php echo base_url();?>index.php/welcome/customer_care" title="Customer Care">Customer Care</a></li>
        <li><a href="<?php echo base_url();?>index.php/welcome/about_us" title="About Us">About Us</a></li>
        <li><a href="<?php echo base_url();?>index.php/welcome/company_info" title="Company Info">Company Info</a></li>
        <!--<li><a href="<?php //echo base_url();?>index.php/welcome/website_info" title="Website Info">Website Info</a></li>-->
        <li><a href="<?php echo base_url();?>index.php/welcome/contact" title="Contact Us">Contact Us</a></li>
        <li></li>
      </ul>
