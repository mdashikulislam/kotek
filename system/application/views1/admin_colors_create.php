<script type="text/javascript">
  ...
  $("#colorForm").validate({
        rules: {  name:{   required : true,  minlength: 3,  maxlength: 15 }, product :{   required : true,  minlength: 3,  maxlength: 15 }          
		  },
...
echo form_open_multipart('admin/colors/create', $fdata);
...
$data = array('name'=>'product','id'=>'product','size'=>25);
echo form_input($data) ."<font color='red'>*</font></p>";
