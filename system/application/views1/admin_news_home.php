...
<a href="<?php echo base_url();?>index.php/admin/news/create" title="Create New News" class="createNews">Create New News</a>
<?php
...
if (count($news)){
	...
	foreach ($news as $key => $list){
		...
		echo "<a href='".base_url()."index.php/admin/news/edit/".$list['id']."' class='icons' title='Edit'><img src='".base_url()."images/icons/edit.png' /></a>";
		//echo " | ";
		...
		echo "<a href='".base_url()."index.php/admin/news/delete/".$list['id']."' class='icons' title='Delete' onClick=\"return deletechecked('Are you sure you want to delete this news ?');\"><img src='".base_url()."images/icons/delete.png' /></a>";
		echo "</td>\n";
		echo "</tr>\n";
	}
	echo "</tbody>\n</table>";
