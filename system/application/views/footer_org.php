...
<div class="footerBottom">
    ...
    <div class="footerNavWrapper">
    	<ul class="footerNav">
            ...
            <li><a href="<?php echo base_url();?>pages/contact" title="Contact Us" <?php $url_key = $this->uri->segment(2); if($url_key ==''){ echo "class='active'";}?> >Contact Us</a> | </li><li><a href="<?php echo base_url();?>pages/faq" title="FAQ" <?php $url_key = $this->uri->segment(2); if($url_key ==''){ echo "class='active'";}?> style="padding-right:0;">FAQ</a>&nbsp;|&nbsp;</li><li><a href="<?php echo base_url();?>pages/view/privacy" title="privacy" <?php $url_key = $this->uri->segment(2); if($url_key ==''){ echo "class='active'";}?> style="padding-right:0;">Privacy Policy</a>&nbsp;|&nbsp;</li>
